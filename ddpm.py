...
Original file is located at
    https://colab.research.google.com/drive/1cvr4XGEGiRgjetT5_M2OzQb4U3AEPtxC
...
# Save the model weights using tf.train.CheckpointManager
checkpoint = tf.train.Checkpoint(ema_network=model.ema_network)
checkpoint_manager = tf.train.CheckpointManager(
    checkpoint, directory="checkpoints", max_to_keep=1
)
checkpoint_manager.save()

# Load the model weights using tf.train.Checkpoint
checkpoint = tf.train.Checkpoint(ema_network=model.ema_network)
